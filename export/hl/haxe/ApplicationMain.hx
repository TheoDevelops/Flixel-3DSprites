...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FlxSprite3D", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("FlxSprite3D", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FlxSprite3D";
		app.meta["name"] = "FlxSprite3D";
